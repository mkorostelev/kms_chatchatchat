...
ActiveRecord::Schema.define(version: 20160902203157) do
  ...
  create_table "users_messages", force: :cascade do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["chat_id"], name: "index_users_messages_on_chat_id", using: :btree
    t.index ["message_id"], name: "index_users_messages_on_message_id", using: :btree
    t.index ["user_id"], name: "index_users_messages_on_user_id", using: :btree
  end

  add_foreign_key "chats_users", "chats"
  add_foreign_key "chats_users", "users"
  add_foreign_key "users_messages", "chats"
